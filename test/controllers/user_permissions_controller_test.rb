...
class UserPermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_permission" do
    assert_difference('UserPermission.count') do
      post user_permissions_url, params: { user_permission: { description: @user_permission.description } }
    end
  ...
  test "should update user_permission" do
    patch user_permission_url(@user_permission), params: { user_permission: { description: @user_permission.description } }
