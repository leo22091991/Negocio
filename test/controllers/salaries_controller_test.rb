...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { gross_salary: @salary.gross_salary, net_salary: @salary.net_salary } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { gross_salary: @salary.gross_salary, net_salary: @salary.net_salary } }
